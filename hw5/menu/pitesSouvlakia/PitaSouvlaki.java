...
/**
* A class for PitaSouvlaki obj, 
*Is the general obj of a pita with its 2 smiles and a pita and also a boolean done(grilled) 
* 
...
public class PitaSouvlaki {
    ...
    /**constructor for this PitaSouvlaki  with its 2 smiles and pita
    */
