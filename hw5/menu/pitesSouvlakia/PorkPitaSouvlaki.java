...
/**
* A class for PitaSouvlaki obj, specifically Pork.
...
public class PorkPitaSouvlaki extends PitaSouvlaki {
	/**constructor for this specific PorkPitaSouvlaki  with its 2 smiles and pita
	*/
    public PorkPitaSouvlaki(Pork a, Pork b, Pita p) {
        super(a, b, p);
    }
}
