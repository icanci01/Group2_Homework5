...
/**
* A class for PitaSouvlaki obj, specifically Sheftalia.
*Specifies what smiles this PitaSouvlaki has. 
* 
...
public class SheftaliaPitaSouvlaki extends PitaSouvlaki {
	/**constructor for this specific SheftaliaPitaSouvlaki  with its 2 smiles and pita
	*/
    public SheftaliaPitaSouvlaki(Sheftalia s, Sheftalia b, Pita p) {
        super(s, b, p);
    }
}
