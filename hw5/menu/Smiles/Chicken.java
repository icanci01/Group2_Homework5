...
/**
* A class for smila obj, specifically chicken.
*It also  generates its own random time it needs for grilling
* 
...
/**constructor for this specific smilla with its size and  its random time it  needs too grill and type
 */
