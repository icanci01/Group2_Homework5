...
/**
* A class for smila obj, specifically Sheftalia.
*It also  generates its own time it needs for grilling
* 
...
/**constructor for this specific smilla with its size and its time it  needs too grill and type
 */
public class Sheftalia extends Smila {
    public Sheftalia(int size) {
        super(size, 25, "Sheftalia");
    }
