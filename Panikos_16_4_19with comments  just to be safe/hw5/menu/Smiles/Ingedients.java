...
/**
* A class for generally what our store cooks. which each has a size, time it need to grill and a boolean of its grilled
* 
...
public class Ingedients {
    ...
    private int size;
    private int time;
    /**constructor for this ingredient with its size and  its time it  needs too grill 
     */
