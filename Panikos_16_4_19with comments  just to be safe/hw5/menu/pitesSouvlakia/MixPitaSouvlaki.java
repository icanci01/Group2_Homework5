...
/**
* A class for PitaSouvlaki obj, specifically Mix.
...
/**constructor for this specific MixPitaSouvlaki  with its 2 smiles and pita
*/
public class MixPitaSouvlaki extends PitaSouvlaki {
    public MixPitaSouvlaki(Sheftalia a, Pork b, Pita p) {
        super(a, b, p);
    }
}
